...
<div class="container">
    ...
    <form action="{{ route('products.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="product_code" class="form-control @error('product_code') is-invalid @enderror" required>
            @error('product_code')
        ...
        <div class="form-group">
            ...
            <input type="date" name="warranty_start_date" class="form-control @error('warranty_start_date') is-invalid @enderror" required>
        ...
        <div class="form-group">
            ...
            <input type="date" name="warranty_end_date" class="form-control @error('warranty_end_date') is-invalid @enderror" required>
